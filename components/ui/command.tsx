...
const CommandDialog = ({ children, ...props }: CommandDialogProps) => {
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0 border border-gray-200">
...
>(({ className, ...props }, ref) => (
  <div>
    <div className="flex items-center border-b px-7 py-3 bg-gray-100 rounded-2xl" cmdk-input-wrapper="">
