...
const getDetail = cache(async (id: string) => {
  const detail: any = await getRequest("/insight/news/" + id);
      ...
      <div className="grid md:grid-cols-3 pt-[4.125rem] gap-10 relative">
        <div className="col-span-2">
          <div className="flex flex-col gap-10">
            ...
            <div className="px-6 py-4 bg-gray-200"><strong>Disclaimer: </strong>The above summary was generated by a state-of-the-art LLM model and is intended for informational purposes only. It is recommended that readers refer to the original article for more context.</div>
            {
              detail?.content &&
              <div className="flex flex-col gap-4">
          ...
          </div>
          {
            ...
            <div className="text-xl pt-8">
              Source: <Link href={detail?.source_url} className="text-[081342] underline text-blue-700">{detail?.source_url}</Link>
            </div>
          }
        ...
        <div className="hidden md:block sticky h-32 top-32">
