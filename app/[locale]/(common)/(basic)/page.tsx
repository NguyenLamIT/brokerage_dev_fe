...
export const metadata: Metadata = {
  ...
  description: "Home",
  openGraph: {
    url: '"https://media-cdn-v2.laodong.vn/storage/newsportal/2023/7/25/1220914/Rose.jpg?w=800&h=496&crop=auto&scale=both"',
    siteName: 'Next.js',
    images: [
      {
        url: '"https://media-cdn-v2.laodong.vn/storage/newsportal/2023/7/25/1220914/Rose.jpg?w=800&h=496&crop=auto&scale=both"',
    ...
    <div>
      ...
      <div className="container py-6">
        <div className="">
          ...
          <div className="grid grid-cols-4 gap-9 items-center justify-center">
              ...
              <div className="flex flex-col justify-center h-full">
                {session?.user ? (
                  <div className="flex flex-col justify-center items-center gap-10">
                    ...
                    <div className="w-3/5">
                      <Separator className="my-1 bg-[#081342]" />
                    </div>
                  </div>
                ) : (
          ...
          <div className="grid grid-cols-4 gap-9 py-12">
            <div className=" col-span-4 lg:col-span-3">
              <div className="pb-6 flex justify-between">
              ...
              <div className="grid lg:grid-cols-3 gap-10">
                {trending.map((data: any) => (
                  ...
                  >
                    ...
                    <p className="text-xl line-clamp-2 min-h-[3.5rem]">{data.summary}</p>
