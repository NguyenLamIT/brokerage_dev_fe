...
const Customize = () => {
    return (
        <div className='text-xl'>
            ...
            <span className="">To view your following and followers list, go to <Link color="primary" className="text-blue-800" href="/seller/profile/premium">Company Workspace - Profile</Link>.</span>
        </div>
    )
}
