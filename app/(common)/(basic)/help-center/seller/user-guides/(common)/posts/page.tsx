...
const Posts = () => {
    return (
        <div className='text-xl'>
            ...
            <span className="  ">You can view and edit all your posts in the <Link color="primary" className="text-blue-800" href="/seller/profile/premium">Profile</Link> page in <span className="font-medium">Company Workspace</span>.</span>
        </div>
    )
}
