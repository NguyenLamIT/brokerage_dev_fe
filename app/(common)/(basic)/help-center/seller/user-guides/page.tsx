...
export const metadata: Metadata = {
    ...
    description: "User Guide for Suppliers",
};
...
const UserGuide = () => {
    return (
        <div className='container py-20 flex flex-col gap-10 md:w-2/3'>
            <h1 className='text-5xl'>User Guide for Suppliers</h1>
            <h5>Everything suppliers need to know to get started in Trade4go</h5>
            {
