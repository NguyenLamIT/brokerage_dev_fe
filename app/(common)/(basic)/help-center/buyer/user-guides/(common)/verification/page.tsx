  ...
  return (
    <div className='text-xl'>
      ...
      <ul className="list-disc text-xl flex flex-col gap-2 px-6">
        ...
        <li className="">Verification details: Additional documentation that proves the legitimacy of your company. Any documents uploaded will be verified by Trade4go , free of charge. (Note: The documents provided will not be disclosed to any third party)</li>
      ...
      Once you have become a verified buyer and added a product of interest, you can participate in Trade4go 's B2B Marketplace.
