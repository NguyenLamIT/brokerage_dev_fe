...
const Posts = () => {
    return (
        <div className='text-xl'>
            ...
            <span className="">Creating posts on feed is a feature that is only available for buyers with access to Tridge's B2B Marketplace. Click <Link color="primary" className="text-blue-800"  href="/help-center/buyer/user-guides/verification">here</Link> to learn more.</span>
            <h2 className="pt-10 pb-6 ">How to create posts</h2>
            Once you have gained access to Tridge's B2B Marketplace, you may create posts on feed.
