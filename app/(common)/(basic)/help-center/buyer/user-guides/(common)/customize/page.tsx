...
const Customize = () => {
    return (
        <div className='text-xl'>
            ...
            <span className=" ">Following other users on feed is a feature that is only available for buyers with access to Trade4go 's B2B Marketplace. Click <Link color="primary" className="text-blue-800"   href="/help-center/buyer/user-guides/verification">here</Link> to learn more.</span>
