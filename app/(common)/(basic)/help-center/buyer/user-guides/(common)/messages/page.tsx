...
const Messages = () => {
    return (
        <div className='text-xl'>
                ...
                <span className="">Messaging is only available for buyers with access to Tridge's B2B Marketplace. Click <Link color="primary" className="text-blue-800" href="/help-center/buyer/user-guides/verification">here</Link> to learn more.</span>
                <h2 className="pt-10 pb-6 ">Send messages</h2>
                Once you have gained access to Tridge's B2B Marketplace, you may contact other verified suppliers and buyers directly on the platform through Tridge's messaging feature.
