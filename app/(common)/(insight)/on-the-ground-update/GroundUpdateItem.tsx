...
const GroundUpdateItem = ({ value }: any) => {
  return (
    <Link href={'/on-the-ground-update/' + value?.title_slug} target="_blank" className="border border-gray-200 rounded-sm p-2">
...
export default GroundUpdateItem