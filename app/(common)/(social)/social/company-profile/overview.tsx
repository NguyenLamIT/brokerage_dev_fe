        ...
        <div className="flex flex-col gap-4">
          ...
          {videos?.map((e: any, index: any) => (
            <div key={index}>
              ...
              {e.path.toLowerCase().includes("www.youtube.com") ? (
                // <iframe
                ...
                <video src={e.path} loop autoPlay muted></video>
              )}
            </div>
          ))}
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            {ce.map((c: any, index: any) => {
              return (
                <div
                  key={index}
                  className="p-3 rounded-lg border border-gray-200 flex justify-between gap-2"
                >
                  <div>
