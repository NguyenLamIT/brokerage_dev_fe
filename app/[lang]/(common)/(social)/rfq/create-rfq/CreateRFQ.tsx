...
const CreateRFQ = (props: any) => {
  ...
  const getSourcingCountry = (values: any) => {
    ...
    if (sourcingCountriesType == "2") {
      ...
      //     });
      //   });
      const country = values.map((e: any) => JSON.parse(e).name);
      const result = "Exclude : " + country.toString();
      return result;
    }
      ...
      <Form {...form}>
        ...
        >
          ...
          <div className="border border-gray-200 p-8 flex flex-col gap-4">
                ...
                return (
                  <FormItem className="w-full">
                    ...
                    <ProductCategory
                      ...
                      className="w-[calc(100vw-4rem)] xs:w-[calc(100vw-4rem)] lg:w-[calc(60vw-4rem)] xl:w-[calc(40vw-4rem)] p-0"
                    ></ProductCategory>
            ...
            <div className="flex flex-col gap-2">
              <RadioGroup className="flex gap-12 flex-wrap" defaultValue="1">
            ...
            <div className="w-full flex flex-col !gap-2">
              ...
              <RadioGroup defaultValue="0">
                <FormItem className="flex gap-12 w-full items-center">
                  <div className="flex gap-2 items-center">
                    <RadioGroupItem
                      value="1"
                      className="w-6 h-6"
